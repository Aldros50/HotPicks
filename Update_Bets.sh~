...
python3 Scrap_nba_schedule.py 2022 02 18
echo "Done"
echo "Updating Game Id Collections : "
root -l -q 'NBA_Update_GameId_Collection.cxx(2022,02,18)'
echo "Done"
echo "Scraping Last Games : "
python3 Scrap_nba.py 20220217
echo "Done"
...
root -l -q 'NBA_Schedule_To_Json.cxx(2022,02,18)'
echo "Done"
